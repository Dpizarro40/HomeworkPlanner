...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "MenuTareas.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "Mis_tareas";
    ...
    void aniadirTarea(String title, String description, String location, String date, String time){
